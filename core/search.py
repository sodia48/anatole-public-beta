...
PAGE_COMMANDS = [
    ...
    ("ETF sectoriels", "screens/26_ETF.py", "etf fnb secteurs sectoriels tsx fonds indiciels historique performance contributions positions holdings xeg xfn xit xre xut xst xic zcn vcn"),
    ...
    ("Terminal Pro", "screens/27_Terminal_Pro.py", "terminal pro radar institutionnel score anatole dislocations rotation secteur leadership risque premium intelligence"),
